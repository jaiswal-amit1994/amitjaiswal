        ...
        <section className="flex items-center py-10">
            <div className="container mx-auto max-w-3xl">
                ...
                <p className="font-light text-muted-foreground">
                    Welcome to [Your Company Name] ("we", "us", or "our"). By
                    accessing or using our website [Your Website URL] (the
                    "Site"), you agree to be bound by these Terms of Service
                    ("Terms"). If you do not agree with these Terms, please do
                    not use our Site.
                </p>

                <h2 className="title pb-2 pt-8">1. Acceptance of Terms</h2>
                <p className="font-light text-muted-foreground">
                ...
                <h2 className="title pb-2 pt-8">2. Changes to Terms</h2>
                <p className="font-light text-muted-foreground">
                    We reserve the right to modify or replace these Terms at any
                    time. If a revision is material, we will provide at least
                    [insert number] days' notice prior to any new terms taking
                    effect. What constitutes a material change will be
                    determined at our sole discretion.
                </p>

                <h2 className="title pb-2 pt-8">3. User Responsibilities</h2>
                <p className="font-light text-muted-foreground">
                    You agree to use our Site in compliance with applicable laws
                ...
                <h2 className="title pb-2 pt-8">4. Intellectual Property</h2>
                <p className="font-light text-muted-foreground">
                    The content and materials on our Site, including text,
                    graphics, logos, and software, are the property of [Your
                ...
                <h2 className="title pb-2 pt-8">5. Limitation of Liability</h2>
                <p className="font-light text-muted-foreground">
                ...
                <h2 className="title pb-2 pt-8">6. Governing Law</h2>
                <p className="font-light text-muted-foreground">
                ...
                <h2 className="title pb-2 pt-8">7. Contact Us</h2>
                <p className="font-light text-muted-foreground">
